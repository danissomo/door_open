...
def ToTestRandomShit():
    ...
    #     dangerQ1 = -0.6
    #     dangerQ2 = -2.2
    #     print(dangerQ1 > robot.GetActualQ()[4] and dangerQ2 < robot.GetActualQ()[4])
    #     print(robot.GetActualQ()[4])
    #     if dangerQ1 > robot.GetActualQ()[4] and dangerQ2 < robot.GetActualQ()[4] :
    #         robot.PoseUnlock()
    #         robot.ForceModeWithSingularityAwoid([0]*6, [0, 1, 1, 1, 0, 1], [2,2,2, math.pi/2, math.pi/2, math.pi/2])
    #     else:
    #         robot.LockPose()
